...
describe('App Component', () => {
  ...
  describe('AppContent', () => {
    ...
    it('should initialize clickability fixes on mount', () => {
      const { initializeClickabilityFixes } = require('./fix-app-issues');
      render(<App />);

      expect(initializeClickabilityFixes).toHaveBeenCalled();
    });
  });
});
...
describe('App Configuration', () => {
  it('should configure QueryClient with correct options', () => {
  ...
  it('should configure ThemeProvider with correct props', () => {
    ...
    // ThemeProvider should be rendered with the correct configuration
    expect(screen.getByTestId('theme-provider')).toBeInTheDocument();
  });

  it('should configure LanguageProvider correctly', () => {
    render(<App />);

    expect(screen.getByTestId('language-provider')).toBeInTheDocument();
  });

  it('should configure AuthProvider correctly', () => {
    render(<App />);
...
describe('App Error Handling', () => {
  it('should handle missing route parameters gracefully', () => {
    // Test that the app doesn't crash with missing parameters
    const { container } = render(
      <MemoryRouter initialEntries={['/athlete-progress']}>
        <App />
      </MemoryRouter>
    );
  ...
  it('should handle special characters in routes', () => {
    const { container } = render(
      <MemoryRouter initialEntries={['/profile/user@example.com']}>
        <App />
      </MemoryRouter>
    );
