        ...
        describe('LanguageContext', () => {
          ...
          describe('LanguageProvider', () => {
            ...
            it('should load language from localStorage if available', () => {
              ...
              expect(contextValue?.language).toBe('es');
          ...
          describe('translation function (t)', () => {
            ...
            it('should handle language switching and return correct translations', () => {
              ...
              // Switch to Spanish (assuming Spanish translations exist)
              act(() => {
                contextValue?.setLanguage('es');
              });
        
              // The translation function should handle the language change
              // Note: Since we don't have Spanish translations in the mock, 
              // it would return the key, but the language state should be updated
              expect(contextValue?.language).toBe('es');
            });
          });
          ...
          describe('provider props', () => {
            it('should render children correctly', () => {
              const TestChild: React.FC = () => <div>Test Child</div>;
