...
export const AssignWorkoutDialog = () => {
  ...
  const {
    ...
    setValue,
    watch,
  } = useForm<AssignWorkoutFormValues>({
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="title">
              {t("assignWorkoutDialog.form.title.label")}
            </Label>
            <Input
              id="title"
              {...register("title")}
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue("athleteId", value)}>
              <SelectTrigger>
                <SelectValue
                  placeholder={t(
                    "assignWorkoutDialog.form.athlete.placeholder",
                  )}
                />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            <Label htmlFor="dueDate">
              {t("assignWorkoutDialog.form.dueDate.label")}
            </Label>
          ...
          >
            {assignWorkout.isPending
              ? t("assignWorkoutDialog.form.submit.assigning")
              : t("assignWorkoutDialog.form.submit.assign")}
          </Button>
        </form>
      </DialogContent>
    </Dialog>
