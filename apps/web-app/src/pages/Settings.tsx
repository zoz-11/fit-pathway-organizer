...
const Settings = () => {
  ...
  // Dialog states
  const [showProfileVisibilityDialog, setShowProfileVisibilityDialog] =
    useState(false);
    ...
    try {
      if (enabled) {
        ...
        const totpFactor = factors?.totp?.find(
          (factor: any) => factor.factorType === "totp",
        );
        if (totpFactor) {
  ...
  return (
    <AppLayout>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          >
              ...
              control={
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    toast.success(
                      `${t("workout.reminders")} ${checked ? t("enabled") : t("disabled")}`,
                    )
                  }
                />
              }
            ...
            <SettingsItem
              ...
              description={t("settings.notifications.progress.description")}
              control={
                <Switch
                  defaultChecked
                  onCheckedChange={(checked) =>
                    toast.success(
                      `${t("progress.updates")} ${checked ? t("enabled") : t("disabled")}`,
                    )
                  }
                />
              }
            />
            <SettingsItem
              label={t("meal.reminders")}
              description={t("settings.notifications.meal.description")}
              control={
                <Switch
                  onCheckedChange={(checked) =>
                    toast.success(
                      `${t("meal.reminders")} ${checked ? t("enabled") : t("disabled")}`,
                    )
                  }
                />
              }
            ...
            <SettingsItem
              ...
              description={t("settings.notifications.social.description")}
              control={
                <Switch
                  defaultChecked
                  onCheckedChange={(checked) =>
                    toast.success(
                      `${t("social.notifications")} ${checked ? t("enabled") : t("disabled")}`,
                    )
                  }
                />
              }
          ...
          >
            <SettingsItem
              ...
              control={
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setShowProfileVisibilityDialog(true)}
                >
                  {t("manage")}
                </Button>
              }
            ...
            <SettingsItem
              ...
              control={
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setShowDataSharingDialog(true)}
                >
                  {t("configure")}
                </Button>
              }
            ...
            <SettingsItem
              ...
              description={t("settings.privacy.2fa.description")}
              control={
                <Button
                  variant="outline"
                  size="sm"
            ...
            <SettingsItem
              ...
              description={t("settings.privacy.password.description")}
              control={
                <Button
                  variant="outline"
                  size="sm"
          ...
          >
            ...
            />
            <SettingsItem
              label={t("settings.preferences.units")}
              description={t("settings.preferences.units.description")}
              control={
                <Select
                  value={units}
                  onValueChange={(value) => {
          ...
          >
            ...
            <SettingsItem
              label={t("sign.out")}
              description={
                t("sign.out.description") || "Sign out of your account"
              }
              control={
                <Button
                  variant="outline"
      ...
      <Dialog
        open={showProfileVisibilityDialog}
        onOpenChange={setShowProfileVisibilityDialog}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("profile.visibility.title")}</DialogTitle>
            <DialogDescription>
              {t("profile.visibility.description")}
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button
              variant="outline"
              size="default"
              onClick={() => setShowProfileVisibilityDialog(false)}
            >
              {t("cancel")}
            </Button>
            <Button
      ...
      {/* Data Sharing Dialog */}
      <Dialog
        open={showDataSharingDialog}
        onOpenChange={setShowDataSharingDialog}
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("data.sharing.title")}</DialogTitle>
            <DialogDescription>
              {t("data.sharing.description")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-base font-medium">
                  {t("data.sharing.analytics")}
                </Label>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t("data.sharing.analytics.description")}
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-base font-medium">
                  {t("data.sharing.thirdparty")}
                </Label>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t("data.sharing.thirdparty.description")}
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-base font-medium">
                  {t("data.sharing.marketing")}
                </Label>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {t("data.sharing.marketing.description")}
                </p>
              </div>
              <Switch
          ...
          <DialogFooter>
            <Button
              variant="outline"
              size="default"
              onClick={() => setShowDataSharingDialog(false)}
            >
              {t("cancel")}
            </Button>
            <Button
      ...
      >
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button size="default" onClick={handleChangePassword}>
              {t("update")}
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={showSupportDialog} onOpenChange={setShowSupportDialog}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button size="default" onClick={handleSendSupportRequest}>
              {t("send.message")}
            </Button>
          </DialogFooter>
        </DialogContent>
