...
export const getCorsHeaders = (origin?: string) => {
  ...
  return {
    ...
    "Content-Security-Policy":
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data:; connect-src 'self' https://*.supabase.co https://api.openrouter.ai https://oauth2.googleapis.com https://api.stripe.com;",
  };
};
